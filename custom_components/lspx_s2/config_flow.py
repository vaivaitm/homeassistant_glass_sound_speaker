"""Config flow to configure LSPX-S2 component."""
...
class LspxS2ConfigFlow(ConfigFlow, domain=DOMAIN):
    """LSPX-S2 configuration flow."""
    ...
    async def async_step_user(
        ...
        self.conf = LspxConfig(name, parsed_url.hostname, endpoint)
    ...
    async def async_step_ssdp(
        ...
        """Handle a discovered LSPX-S2 device."""
        ...
        if "videoScreen" in service_types or "video" in service_types:
            return self.async_abort(reason="not_lspx_s2_device")
        ...
        self.conf = LspxConfig(friendly_name, hostname, endpoint)
